...
Place the file in your project root or inside the `trainloop/` folder. You can override the location with the `--config` option or the [`TRAINLOOP_CONFIG_PATH`](./cli-env-vars#trainloop_config_path) environment variable.
